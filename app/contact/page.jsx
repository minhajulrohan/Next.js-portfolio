          ...
          <div className="xl:w-1/2 order-2 xl:order-none">
            <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
              ...
              <p className="text-white/60">
                Environment Variables: Ensure that your NEXT_PUBLIC_PASSWORD environment variable is correctly set and accessible in your environment. Double-check if it's loaded properly.
              </p>
              {/* input */}
